...
_PLAYLISTDOCUMENT = DESCRIPTOR.message_types_by_name['PlaylistDocument']
_SETTINGSDOCUMENT = DESCRIPTOR.message_types_by_name['SettingsDocument']
_PLAYLISTDOCUMENT_TYPE = _PLAYLISTDOCUMENT.enum_types_by_name['Type']
